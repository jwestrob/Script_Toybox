...
parser.add_argument('--similarity_threshold', type=float, default=50, help='Sequence similarity threshold for drawing edges. Default is 50.')
...
for line in data:
    ...
    if query_protein != subject_protein and percent_identity >= args.similarity_threshold:
